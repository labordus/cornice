...
""")
        ...
        wx.EVT_MENU(self, wx.xrc.XRCID('cut'),
                    lambda e: self.picture_list.clipboard_cut())
        wx.EVT_MENU(self, wx.xrc.XRCID('copy'),
                    lambda e: self.picture_list.clipboard_copy())
...
def main(path, slideshow, quickstart):
    ...
    if wx.Platform != '__WXGTK__':
        ...
        try:
            viewer._blank_cursor = wx.CursorFromImage(wx.EmptyImage(1, 1))
        except AttributeError:
